...
class TetrisEnv(gym.Env):
    ...
    def __init__(self, width=10, height=20, obs_type='ram', extend_dims=False, render_mode='rgb_array',
                 reward_step=False, penalise_height=False, penalise_height_increase=False, advanced_clears=False,
                 high_scoring=False, penalise_holes=False, penalise_holes_increase=False, lock_delay=0, step_reset=False):
        self.width = width
        self.height = height
        ...
        self.engine = TetrisEngine(width, height, lock_delay, step_reset, reward_step, penalise_height,
                                   penalise_height_increase, advanced_clears, high_scoring, penalise_holes,
